library flutter_update_version;
...
class UpdateVersion {
  ...
  // Future<void> buildConfirmBottomSheet({
  ...
  //   };
    ...
    //       action: allowDismissal
    //           ? DuplicateButton(
    //         size: Size(double.infinity, 20),
    //         radius: Constant.borderRadiusDefault,
    //         textColorOLB: Colors.white,
    //         titleLeft: 'TXT_SKIP',
    //         titleRight: 'TXT_UPDATE',
    //         functionLeft:() async {
    //           await SharedPrefsService.setVersionSkip(versionStatus.storeVersion ??  versionStatus.localVersion);
    //           Navigator.of(navigationService.getContext(), rootNavigator: true).pop();
    //         },
    //         functionRight: updateAction,
    //       )
    //           : Align(
    //         alignment: Alignment.centerRight,
    //         child: ContainedButton(
    //           padding: const EdgeInsets.symmetric(horizontal: 40, vertical: 8),
    //           borderRadius: Constant.borderRadiusDefault,
    //           onPress: updateAction,
    //           title: 'TXT_UPDATE',
    //         ),
    //       ),
    //       message: 'MSG_PLEASE_UPDATE_APP',
    //     );
    //   },
    // );
  // }
